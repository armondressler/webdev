...
/*** The Medicines ***/
  ...
  echo "<h4 id=\"administered\">Medicines taken</h2>";
    ...
    // - ..and then display this now completed list
  $sql = "SELECT
...
/*** TO DO ***/
/* wases aber no ztüe git /was noni funktioniert bi mir:
*-1- i schaffe's nid, dass IMMER ds css gläse wird (vgl. tldr vo hüt am Morge.. - betrifft ds Usblände vo de ungfiuterete VitalSigns)
*-2- i weis nid, wie das me VO IRGENDWO cha a js-funktion ufrüefe - das wäri nötig zum (nachem Yygää vonem nöie VitalSign) wider nume die VitalSigns aazeige, wo me dervo grad eis het yygää
*  2a- zudäm mues me immer öppe 3-4x dSyte nöi lade, bis ändlech di nöii Mässig aazeigt wird (und, wöu ig ds Yytraage vonem nöie Wärt mit GET gmacht ha, mues me ufpasse, dass me de nid 100x die glyche Date (ir url) nomau a dDatebank schickt)
*-3- input validation wääri no guet für bim
*  -3a- Mässwärte-Yygaabefäud: <input type="text" name="newMeasurement"
*  -3b- Bemerkig-Yygaabefäud zu Medikamänte-Abgaab:<textarea name="note_newMed" -> to be filtered out if possible: linebreak ('%0D%0A') and multiple-space (multiples of '+'), and maybe other symbols disturbing GET-messages..!
*-4- wi ou scho gseit: i ha nid usegfunge, wi me e Dropdownlyschte-Tegschtfäud-Kombination härebechunt (vgl. äbefaus myni Nachrichte vo hüt am Morge: ha es Bischpiu im Netz gfunge, ha's usenanggnoo und die versch. Komponänte (js, css, html) bi üüs yybout - aber es funktioniert nid (ds usenanggnoonige Originau aber yywandfrei)
*-5- ds "logout" hätti gärn y "Footer" taa - aber ha's nid gschaft. (ghöört ja äue sowiso eher y dyni, html/css-Wäut..)
*-...-
*-n- u de hätte mir de nume ersch fang dGrundaaforderige erfüut. Dr Benoist schrybt ja: "the sky is the limit! I'd like to be astonished!" - das wird chly schwirig..
 */
